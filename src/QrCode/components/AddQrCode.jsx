      ...
      {loading ? (
        ...
        <div className="grid grid-cols-6 gap-2">
          <Card className="w-[250px] h-[250px]">
            ...
            <CardContent>
              <div className=" flex gap-10 m-5 mt-0">
                <QRCode
                  id="qrcode-id-unique"
          ...
          {QrCode.length > 0 &&
            QrCode.map((item, index) => {
              ...
              const urlWithParams = `${baseUrl}?table_id=${encodeURIComponent(
                item.table_id
              )}`;
              return (
                <div key={index}>
                            ...
                            <div className="flex items-center justify-end w-full pt-6 space-x-2">
                              <DialogClose>
                                ...
                                <Button
                                  ...
                                  variant="darkBlack"
                                  onClick={() => handleDelete(item.id, QrCode)}
                                >
                                  Continue
                                </Button>
                              </DialogClose>
                  ...
                  {/* <Dialog >
                    ...
                    <div className=' flex gap-10 m-5 mt-10 ml-10'>
