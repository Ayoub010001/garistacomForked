...
export default function NavBar() {
    ...
    channel.bind("form-submited", function (data) {
      try {
        ...
        if (parseInt(resoIdNoti) === restoInfo.id) {
          console.log(
            "New notification for current restaurant:",
            newNotification
          );
  ...
  return (
    <div className="fixed top-0 left-0 z-20 w-full bg-white border-b">
      <div className="flex items-center h-16 px-4">
        <div className="flex items-center ml-auto space-x-8" dir="rtl">
          <UserNav />
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  <div className=" flex gap-10 m-5 mt-10">
                    <QRCode
              ...
              <div className=" flex items-center justify-center">
                ...
                {/* <input type="url" id="example8" className="focus:z-10 focus:border-primary-400 focus:ring focus:ring-primary-200 focus:ring-opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-600 block w-full h-10 pl-2 border-gray-600 rounded-r-none shadow-sm" placeholder="example.com" value="https://sailboatui.com/" disabled/> */}
                <div className="relative z-0 flex">
                  <div className="flex items-center justify-center gap-2">
                    <div className="focus:z-10 focus:border-primary-400 focus:ring focus:ring-primary-200 focus:ring-opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-600 block w-full pl-2 border-gray-600 rounded-r-none shadow-sm">
                      {qrCodeURL}
                    </div>
                    <div>
                      <button
                        ...
                        htmlFor="example8"
                        className="flex items-center space-x-4 rounded-md rounded-l-none border  border-gray-300 px-2.5 text-gray-700 hover:bg-gray-100"
                      >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button className="relative" size="icon" variant="ghost">
                ...
                {notifications.length != 0 && (
                  <span className="-top-1 -right-1 absolute w-3 h-3 bg-red-500 rounded-full" />
                )}
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent className="w-80 p-4">
              ...
              <div className="space-y-4">
                {notifications.length == 0 ? (
                  <p className="dark:text-gray-400 ml-5 text-sm text-gray-500">
                    No notifications
                  </p>
                ) : (
                  notifications
                    ...
                    .map((notification, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-start gap-3">
                          <div className="dark:bg-blue-900 flex items-center justify-center w-10 h-10 bg-blue-100 rounded-full">
                            <CalendarCheck2Icon className="dark:text-blue-400 w-5 h-5 text-blue-500" />
                          </div>
                          <div>
