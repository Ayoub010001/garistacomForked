...
function Footer({
  ...
  return (
    ...
    <Link to={`/theme/${slug}`} className='inline-flex '>
        ...
        <Link to={`/theme/${slug}/Claims`} className='inline-flex'>
        <button type="button" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <Link to={`/theme/${slug}/Achat`} className='inline-flex'>
        <button type="button" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <Link to={`/theme/${slug}/info`} className='inline-flex '>
        <button type="button" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
