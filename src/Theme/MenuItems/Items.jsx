                ...
                <CredenzaTrigger asChild>
                  <Button>
                    <div className="relative shadow-md rounded-[10px] border-gray-300 border inline-block">
                      <div className="tab items-center justify-center h-auto w-[150px] overflow-hidden p-1.5 text-lg font-semibold rounded-[8px] cursor-pointer transition-colors">
                        <img
                          src={item.image}
                          alt="Menu Icon"
