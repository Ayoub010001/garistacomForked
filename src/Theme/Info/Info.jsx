      ...
      <ScrollArea className="h-[900px] w-auto rounded-md border p-4">
        <div className="container">
          <div className="mt-8">
            <div className="flex flex-col gap-2 items-center justify-center">
              ...
              <img
                ...
                alt="Menu Icon"
                loading="lazy"
                className="w-24 h-24 rounded-full bg-black outline-2 outline outline-blue border border-1 border-white"
              />
              <div>
                <h1>{items.name}</h1>
              </div>
          ...
          <div className="w-full max-w-sm px-2 ">
            <div className="flex items-center rounded-[1rem] ">
              ...
              <button
                ...
                className="flex-shrink-0 z-10 inline-flex items-center py-3 px-4 text-sm font-medium text-center text-white bg-[#28509E] rounded-e-lg hover:bg-[#28509E] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 border border-blue-700 dark:border-blue-600 hover:border-blue-800 dark:hover:border-blue-700"
                type="button"
              >
          ...
          <div className="flex gap-2 justify-center items-center pt-10 max-w-sm   ">
            <BsFillTelephoneFill />
            <span className="font-bold">:</span> +212 {infoRes.phone}
          </div>
          {/* <div className="mt-8">
