      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            ...
            <UpdateForm handleImageUpdate={handleImageUpdate} isDialogOpen={updateFormState} categories={categories} setIsDialogOpen={setUpdateFormState} id={row.original.id} handleUpdate={handleUpdate}/>
