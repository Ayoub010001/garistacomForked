...
} from "./chunk-ZIKXRKWO.js";
import {
  $f631663db3294ace$export$b39126d51d94e6f3
} from "./chunk-NNF7GGLL.js";
import "./chunk-4FDWGFHA.js";
import {
  $b3bbe2732c13b576$export$bea8ebba691c5813
} from "./chunk-ER2OHT27.js";
import "./chunk-6NIUGPUU.js";
import {
  $c512c27ab02ef895$export$50c7b4e9d9f19c1
} from "./chunk-SCV5CAN5.js";
import {
  $71cd76cc60e0454e$export$6f32135080cb4c3
} from "./chunk-FJJR6JCK.js";
import "./chunk-Q64K2RNE.js";
import "./chunk-MZJQRB7F.js";
import {
  $8927f6f2acc4f386$export$250ffa63cdc0d034
} from "./chunk-MQWPHZV7.js";
import "./chunk-NIIQ5B24.js";
import "./chunk-5ZTRN26I.js";
import {
  _extends
...
var $6c1fd9e6a8969628$export$af3ec21f6cfb5e30 = import_react.default.forwardRef((props, forwardedRef) => {
  const { type, ...toggleGroupProps } = props;
  if (type === "single") {
    const singleProps = toggleGroupProps;
    return import_react.default.createElement($6c1fd9e6a8969628$var$ToggleGroupImplSingle, _extends({}, singleProps, {
      ref: forwardedRef
    }));
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return import_react.default.createElement($6c1fd9e6a8969628$var$ToggleGroupImplMultiple, _extends({}, multipleProps, {
      ref: forwardedRef
    }));
  }
...
var $6c1fd9e6a8969628$var$ToggleGroupImplSingle = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  return import_react.default.createElement($6c1fd9e6a8969628$var$ToggleGroupValueProvider, {
  ...
  }, import_react.default.createElement($6c1fd9e6a8969628$var$ToggleGroupImpl, _extends({}, toggleGroupSingleProps, {
    ref: forwardedRef
  })));
});
var $6c1fd9e6a8969628$var$ToggleGroupImplMultiple = import_react.default.forwardRef((props, forwardedRef) => {
  const { value: valueProp, defaultValue, onValueChange = () => {
  ...
  }, import_react.default.createElement($6c1fd9e6a8969628$var$ToggleGroupImpl, _extends({}, toggleGroupMultipleProps, {
    ref: forwardedRef
  })));
});
Object.assign($6c1fd9e6a8969628$export$af3ec21f6cfb5e30, {
...
var $6c1fd9e6a8969628$var$ToggleGroupImpl = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  return import_react.default.createElement($6c1fd9e6a8969628$var$ToggleGroupContext, {
    scope: __scopeToggleGroup,
    rovingFocus,
    disabled
  }, rovingFocus ? import_react.default.createElement($d7bdfb9eb0fdf311$export$be92b6f5f03c0fe9, _extends({
    asChild: true
  }, rovingFocusGroupScope, {
    orientation,
    dir: direction,
    loop
  }), import_react.default.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, commonProps, {
    ref: forwardedRef
  }))) : import_react.default.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, commonProps, {
    ref: forwardedRef
  })));
...
var $6c1fd9e6a8969628$export$b453109e13abe10b = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  return context.rovingFocus ? import_react.default.createElement($d7bdfb9eb0fdf311$export$6d08773d2e66f8f2, _extends({
    asChild: true
  }, rovingFocusGroupScope, {
    focusable: !disabled,
    active: pressed,
    ref
  }), import_react.default.createElement($6c1fd9e6a8969628$var$ToggleGroupItemImpl, _extends({}, commonProps, {
    ref: forwardedRef
  }))) : import_react.default.createElement($6c1fd9e6a8969628$var$ToggleGroupItemImpl, _extends({}, commonProps, {
    ref: forwardedRef
  }));
...
var $6c1fd9e6a8969628$var$ToggleGroupItemImpl = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  return import_react.default.createElement($b3bbe2732c13b576$export$bea8ebba691c5813, _extends({}, typeProps, itemProps, {
    ref: forwardedRef,
