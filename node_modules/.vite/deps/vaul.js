...
} from "./chunk-FTTXLQST.js";
import "./chunk-6CGW25OW.js";
import "./chunk-2N3YFXZ5.js";
import "./chunk-6NIUGPUU.js";
import "./chunk-QXSAKO4Y.js";
import "./chunk-I4HLCIDP.js";
import "./chunk-FJJR6JCK.js";
import "./chunk-Q64K2RNE.js";
import "./chunk-SCV5CAN5.js";
import "./chunk-MZJQRB7F.js";
import "./chunk-NEQ3MP2D.js";
...
function Root({ open: openProp, onOpenChange, children, shouldScaleBackground, onDrag: onDragProp, onRelease: onReleaseProp, snapPoints, nested = false, setBackgroundColorOnScale = true, closeThreshold = CLOSE_THRESHOLD, scrollLockTimeout = SCROLL_LOCK_TIMEOUT, dismissible = true, handleOnly = false, fadeFromIndex = snapPoints && snapPoints.length - 1, activeSnapPoint: activeSnapPointProp, setActiveSnapPoint: setActiveSnapPointProp, fixed, modal = true, onClose, noBodyStyles, direction = "bottom", preventScrollRestoration = true, disablePreventScroll = false }) {
  ...
  return import_react.default.createElement($5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9, {
    modal,
    onOpenChange: (o) => {
      if (openProp !== void 0) {
...
var Overlay = import_react.default.forwardRef(function({ children, ...rest }, ref) {
  const { overlayRef, snapPoints, onRelease, shouldFade, isOpen, visible } = useDrawerContext();
  const composedRef = useComposedRefs(ref, overlayRef);
  const hasSnapPoints = snapPoints && snapPoints.length > 0;
  return import_react.default.createElement($5d3850c4d0b4e6c7$export$c6fdb837b070b4ff, {
    onMouseUp: onRelease,
    ref: composedRef,
    "vaul-drawer-visible": visible ? "true" : "false",
    "vaul-overlay": "",
...
var Content = import_react.default.forwardRef(function({ onOpenAutoFocus, onPointerDownOutside, onAnimationEnd, style, ...rest }, ref) {
  ...
  return import_react.default.createElement($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, {
    "vaul-drawer": "",
